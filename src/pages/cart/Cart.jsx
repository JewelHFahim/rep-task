      ...
      <div className="bg-gray-100 dark:bg-gray-800 ">
        ...
        <div className="container mx-auto">
          ...
          <div className="lg:flex shadow-md h-screen">
            ...
            <div className=" lg:w-3/4 bg-white dark:bg-gray-800 px-10 py-10">
              <div className="flex justify-between border-b pb-2 lg:pb-8 mb-5 lg:mb-0">
                <h1 className="font-semibold text-2xl text-gray-600 dark:text-gray-100">
                  Shopping Cart
                </h1>
                <h2 className="font-semibold text-2xl text-gray-600 dark:text-gray-100">
                  {products.length} Items
                </h2>
              </div>

              <div className="hidden lg:flex mt-10 mb-5 font-semibold text-xs text-gray-600 dark:text-gray-100 uppercase">
              ...
              <div className="px-4 lg:px-0">
                {products.length === 0 ? (
                  <p className="text-center text-xl text-slate-100 dark:text-slate-600 py-6">
                  ...
                  <div className="flex flex-col gap-y-2">
                    {products?.map((product, i) => (
                      <div
                        key={i}
                        className="flex justify-between items-center hover:bg-gray-100 dark:hover:bg-gray-700 -mx-8 p-2 lg:px-6 lg:py-5 text-gray-600 dark:text-gray-100 border"
                      >
                        <div className="flex items-center w-2/5">
                          ...
                          <div className="flex flex-col lg:gap-2 justify-between items-start ml-2 lg:ml-4 flex-grow">
                            ...
                            <span className="hidden lg:block text-green-500 text-xs">
                              {product.category}
                            </span>
            ...
            <div className=" lg:w-1/4 px-8 py-10 bg-white bg shadow dark:bg-gray-700 text-gray-600 dark:text-gray-100">
              ...
              <div className="border-t mt-8">
                <div className="flex font-semibold justify-between py-6 text-sm ">
                  ...
                  <span> {(total + total * 0.001).toFixed(2)} Tk</span>
                </div>
